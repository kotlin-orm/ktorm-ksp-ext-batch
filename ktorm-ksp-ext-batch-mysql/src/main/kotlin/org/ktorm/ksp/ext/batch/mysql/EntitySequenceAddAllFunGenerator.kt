 ...
 */
package org.ktorm.ksp.ext.batch.mysql
...
public class EntitySequenceAddAllFunGenerator : TopLevelFunctionGenerator {
    ...
    private val bulkInsertFun = MemberName("org.ktorm.support.mysql", "bulkInsert", true)
    private val defaultValueFun = MemberName("org.ktorm.support.mysql", "defaultValue", true)
